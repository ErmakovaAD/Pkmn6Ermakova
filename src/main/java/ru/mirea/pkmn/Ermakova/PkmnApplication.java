package ru.mirea.pkmn.Ermakova;

import com.fasterxml.jackson.databind.JsonNode;
import ru.mirea.pkmn.AttackSkill;
import ru.mirea.pkmn.Card;
import ru.mirea.pkmn.Ermakova.web.http.PkmnHttpClient;
import ru.mirea.pkmn.Ermakova.web.jdbc.DatabaseServiceImpl;
...
public class PkmnApplication {
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, SQLException {
        ...
        Card import_some_card = cardExport.deserialize("src/main/resources/Dewgong.crd");
